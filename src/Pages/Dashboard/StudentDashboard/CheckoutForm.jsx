...
console.log(mySelected)
     useEffect(()=>{
        // console.log(price)
        // ekhane sokol information send kora jabe payment historir jonno
     if(price > 0){
    ...
    return (
     <>
      <form onSubmit={handleSubmit}>
       ...
       <button type="submit" className="btn btn-sm btn-wide btn-primary mt-4 inline-flex justify-center ms-[100px]" disabled={!stripe || !clientSecret }>
          Pay
        </button>
