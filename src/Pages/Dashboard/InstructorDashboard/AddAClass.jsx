...
// class_image_url,available_seats,instructor_name,instructor_email,category,number_of_students,price,class_name
const AddAClass = () => {
    const {user} = useAuth()
    ...
    return (
        ...
        <SectionTitle  heading={" Instructor Add A Class"}/>
          ...
          <div className="form-control">
              ...
              <input type="text" {...register("class_name", { required: true })} name="class_name" placeholder="class name" className="input input-bordered w-[400px]" />
            </div>
            <div className="form-control">
              <label className="label">
                <span className="label-text">Class Photo</span>
              </label>
              <input type="file" {...register("class_image_url", { required: true })} name="class_image_url" placeholder="Class Photo" className="input input-bordered w-1/2" />
             </div> 
            <div className="form-control">
              <label className="label">
                <span className="label-text">Instructor Photo</span>
              </label>
              <input readOnly defaultValue={user?.photoURL || 'https://i.ibb.co/JdM7pdM/IMG-2061.jpg' } type="text" {...register("instructor_image_url", { required: true })} name="instructor_image_url" placeholder="Instructor Photo" className="input input-bordered w-1/2" />
             </div> 
          </div>
